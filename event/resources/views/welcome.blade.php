          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="details">
                  ...
                  <div class="social">
                    <a class="buy-tickets scrollto" href="event-details.html"
                      >Tham gia ngay</a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="details">
                  <h3>
                    <a class="text-overflow" href="event-details.html"
                      >VÒNG CHUNG KẾT CUỘC THI ONLINE VỀ TÌM HIỂU Ô TÔ VÀ
                      ATGT</a
                    >
                  </h3>
                ...
                <div class="details">
                  <h3>
                    <a href="event-details.html"
                      >LỄ KÝ KẾT MOU VỚI CÔNG TY CORETECH</a
                    >
                  </h3>
                  <p>7:00 - 18/10/2021, Tổ chức online</p>
                  <div class="social">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="details">
                  <h3>
                    <a href="event-details.html"
                      >LỄ KHAI GIẢNG - ĐÊM NHẠC HỘI CHÀO ĐÓN KHÓA 26</a
                    >
                  </h3>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="details">
                  <h3>
                    <a href="event-details.html"
                      >SINH HOẠT CÔNG DÂN CHUYÊN ĐỀ TẬP TRUNG - K23-NHÓM 2 VÀ
                      K24-KCT</a
                    >
                  </h3>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="speaker" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="details">
                  <h3>
                    <a href="event-details.html"
                      >TỔ CHỨC SHCD CẤP KHOA CHO SV KHÓA 23, 24, 25 KHOA QTKD</a
                    >
                  </h3>
                  <p>16:30 - 07/09/2020, Hội trường Trịnh Công Sơn, CS3</p>
                  <div class="social">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-4 col-md-6">
              <div class="like">
                ...
                <h3>
                  <a href="#"
                    >LỄ TRAO CHỨNG NHẬN QS-STARs 4 SAO VÀ LỄ KHAI GIẢNG KHÓA 27
                    NĂM HỌC 2021 - 2022</a
                  >
                </h3>
                <div class="hearts">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="like">
                ...
                <h3>
                  <a href="#"
                    >TẬP HUẤN KỸ THUẬT VIÊN CHƯƠNG TRÌNH BẢO DƯỠNG XE MÁY</a
                  >
                </h3>
                <div class="hearts">
        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide">
              <a href="/img/gallery/1.jpg" class="gallery-lightbox"
                ><img src="/img/gallery/1.jpg" class="img-fluid" alt=""
              /></a>
            </div>
            <div class="swiper-slide">
              <a href="/img/gallery/1.jpg" class="gallery-lightbox"
              ...
              <ul class="faq-list">
                <li>
                  ...
                  >
                    ...
                    được duyệt? <i class="bi bi-chevron-down icon-show"></i
                ...
                <li>
                  ...
                  >
                    ...
                    lúc? <i class="bi bi-chevron-down icon-show"></i
                    ><i class="bi bi-chevron-up icon-close"></i>
                  </div>
